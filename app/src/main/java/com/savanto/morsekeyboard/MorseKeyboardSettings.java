...
public class MorseKeyboardSettings extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.dah = (SeekBarPreference) ps.findPreference(this.getText(R.string.pref_key_dah));
        this.shortGap = (SeekBarPreference) ps.findPreference(this.getText(R.string.pref_key_short_gap));
        this.mediumGap = (SeekBarPreference) ps.findPreference(this.getText(R.string.pref_key_medium_gap));
        this.autoshift = (CheckBoxPreference) ps.findPreference(this.getText(R.string.pref_key_autoshift));
        this.autocaps = (CheckBoxPreference) ps.findPreference(this.getText(R.string.pref_key_autocaps));
    ...
    protected void onResume() {
        ...
        // Set initial capitalization checkboxes to exclude each other
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        ...
        if (pref instanceof SeekBarPreference) {
            final SeekBarPreference seekBarPref = (SeekBarPreference) pref;
            pref.setSummary(Integer.toString(seekBarPref.getProgress()) + seekBarPref.getUnits());
        } else if (key.equals(this.getString(R.string.pref_key_autoshift))) {
        ...
        } else if (key.equals(this.getString(R.string.pref_key_autocaps))) {
