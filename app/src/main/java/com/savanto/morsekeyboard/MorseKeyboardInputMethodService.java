...
public class MorseKeyboardInputMethodService extends InputMethodService implements
    ...
    public void onCreate() {
        ...
        this.unshifted = res.getDrawable(R.drawable.key_unshifted);
        this.shifted = res.getDrawable(R.drawable.key_shifted);
    ...
    private boolean appendMorse(int signal) {
        ...
        if (this.morseString.length() >= 8) {
            Toast.makeText(this, R.string.error_morse_length_exceeded, Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        case MorseKeyboard.KEYCODE_REFERENCE:
            final AlertDialog ref = new AlertDialog.Builder(this)
            ...
            final Window window = ref.getWindow();
        ...
        case MorseKeyboard.KEYCODE_GAP:
            ...
            if (this.morse > 0) {
                String s = MorseCode.lookup(this.morse);
                if (s == null) {
                    Toast.makeText(this, R.string.error_morse_not_recognized, Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private class GapTimer extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onProgressUpdate(Void... progress) {
            ...
            if (MorseKeyboardInputMethodService.this.morse > 0) {
                String s = MorseCode.lookup(MorseKeyboardInputMethodService.this.morse);
                if (s == null) {
                    Toast.makeText(
                            MorseKeyboardInputMethodService.this,
                            R.string.error_morse_not_recognized,
                            Toast.LENGTH_SHORT
                    ).show();
                    this.cancel(true);
                    return;
    ...
    @Override
    public void onText(CharSequence arg0) { /* NOP */ }

    @Override
    public void swipeDown() { /* NOP */ }

    @Override
    public void swipeLeft() { /* NOP */ }

    @Override
    public void swipeRight() { /* NOP */ }

    @Override
    public void swipeUp() { /* NOP */ }
}
